...
With all of this data, we can put our attention on the Fisher's Exact test. The p-value displayed above is extremely small at 5e-14. This is a really small number, the smaller the number the more it points that the vaccine may have an impact depending on gender. The 95 percent confident interval is 1.8. 
...
With all of this data, we can put our attention on the Fisher's Exact test. The p-value displayed above is small at 2e-04. This is a really small number, the smaller the number the more it points that the vaccine may have an impact depending on gender.
...
Looking at the Fisher's Exact Test for count data, the P value is 1e-08. We can infer that this vaccine isn't as effective for this category of people within the sample. 
